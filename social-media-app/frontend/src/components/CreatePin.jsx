...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    if (type === 'image/jpg' || type === 'image/jpeg' || type === 'image/svg' || type === 'image/gif' || type === 'image/tiff' || type === 'image/png') {
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>Use high-quality JPG, SVG, PNG or GIF less than 20 MB. </p>
                </div>
                <input
                  type="file"
                  name='upload-image'
